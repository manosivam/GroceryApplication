...
public class DB {
	...
	public Map<String, Customer> addFewCustomers()
	{
	...
	public ArrayList<ItemType> addFewItemTypes()
	{
		try {
		...
		return itemTypesAvailableInIntentory;
	}
	...
	public double getTaxPercentForItemTypeFromDB(String itemTypeName){
